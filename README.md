...
1.	Получение имени хоста http://localhost:8080/api/v1/status
2.	Получение всех данных в таблице http://localhost:8080/api/v1/cars
3.	Получение данных по указанному ID http://localhost:8080/api/v1/cars/3
